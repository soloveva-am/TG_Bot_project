...
import pickle
import os.path
if not os.path.exists('../timetable/TimetableDB.pickle'):
    with open('../timetable/TimetableDB.pickle', 'wb') as f:
        pickle.dump(TimetableDB, f, pickle.HIGHEST_PROTOCOL)
else:
    with open('../timetable/TimetableDB.pickle', 'rb') as f:
